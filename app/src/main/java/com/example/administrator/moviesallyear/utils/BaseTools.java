...
public class BaseTools {
    ...
    public static String getVersionName() {
        // 获取packagemanager的实例
        PackageManager packageManager = MoviesAllYearApplication.getInstances().getPackageManager();
        // getPackageName()是你当前类的包名，0代表是获取版本信息
        PackageInfo packInfo = null;
        try {
            packInfo = packageManager.getPackageInfo(MoviesAllYearApplication.getInstances().getPackageName(), 0);
    ...
    public static void copy(String content) {
        // 得到剪贴板管理器
        ClipboardManager cmb = (ClipboardManager) MoviesAllYearApplication.getInstances().getSystemService(Context.CLIPBOARD_SERVICE);
